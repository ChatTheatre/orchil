...
//-----Component Setup
	...
	/*	addComponent('chat_theatre'   , 'left'    , false, 'openerWin', ['http://ironclaw.skotos.net/'], '<img alt="Grand Theatre" src="//www.skotos.net/IronclawGame/images/gamelogo.gif">'); */
		...
		addComponent('help'     , 'right'   , false, 'openerWin', ['http://wp.skotos.net/ironclaw/help/'], '<div class="button" title="Help Files">Help Files</div>');
		addComponent('events'     , 'right'   , false, 'openerWin', ['http://wp.skotos.net/ironclaw/events/'], '<div class="button" title="Current Events">Current Events</div>');
		addComponent('vote_ico'       , 'right'   , false, 'openerWin', ['http://www.topmudsites.com/vote-ironclaw.html'], '<div class="button" alt="Vote for Ironclaw" title="Vote for Ironclaw on TopMudSites">Vote for Ironclaw</div>');
...
//-----Component Functionality
	...
	function popupMapWindow() {
		popupArtWin(bigMapHREF, 'Map', 'Ironclaw Overview Map');
	}
...
//-----Library Functions
	...
	function popupArtWin(filename, windowname, windowtitle) {
		...
		artwin = window.open('http://ironclaw.skotos.net/Theatre/Art.sam?url=' +
