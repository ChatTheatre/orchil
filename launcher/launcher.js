...
//-----Component Setup
	...
	/*	addComponent('chat_theatre'   , 'left'    , false, 'openerWin', ['http://ironclaw.skotos.net/'], '<img alt="Grand Theatre" src="//www.skotos.net/IronclawGame/images/gamelogo.gif">'); */
        ...
        document.getElementById('right').appendChild(document.getElementById('status'));
        document.getElementById('right').appendChild(document.getElementById('resources'));
...
//-----Component Functionality
	...
	function popupMapWindow() {
		popupArtWin(bigMapHREF, 'Map', 'The New World Map');
	}
...
//-----Library Functions
    ...
    function update(input) {
        ...
        if(msg == "health") {
             ...
             document.getElementById("wood").innerText = curr;
        } else if(msg == "stone") {
             document.getElementById("stone").innerText = curr;
        } else if(msg == "metal") {
             document.getElementById("metal").innerText = curr;
        } else if(msg == "textile") {
             document.getElementById("textile").innerText = curr;
        } else if(msg == "food") {
             document.getElementById("food").innerText = curr;
        }
    }
