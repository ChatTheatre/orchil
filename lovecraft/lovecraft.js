...
//-----Component Setup
	...
	function initTheatre() {
		addComponent('chat_theatre'   , 'left'    , false, 'openerWin', ['http://lovecraft.skotos.net/'], '<img alt="Grand Theatre" src="http://www.skotos.net/LCGame/client/gamelogo.jpg">');
		...
		addComponent('newplayers'     , 'right'   , false, 'openerWin', ['http://lovecraft.skotos.net/Theatre/starting.sam'], '<div class="button" alt="Getting Started" title="Getting Started">Getting Started</div>');
		addComponent('newplayers'     , 'right'   , false, 'openerWin', ['http://lovecraft.skotos.net/Theatre/mastering.sam'], '<div class="button" alt="Mastering Chat" title="Mastering Chat">Mastering Chat</div>');
		addComponent('vote_cm'       , 'right'   , false, 'openerWin', ['http://www.topmudsites.com/vote-arkham.html'], '<div class="button" alt="Vote for Lovecraft Country" title="Vote for Lovecraft Country on TopMudSites">Vote Now</div>');
	...
	function updateCompass(bitfield, image, dir, bit) {
		...
		if (bitfield & bit) {
  	    	image.style.backgroundImage = "url(http://www.skotos.net/LCGame/client/arrows/" + dir + "-ex.gif)";
		} else {
	    	image.style.backgroundImage = "url(http://www.skotos.net/LCGame/client/arrows/" + dir + "-noex.gif)";
		}
    }
...
//-----Library Functions
	...
	function popupArtWin(filename, windowname, windowtitle) {
		...
		artwin = window.open('http://lovecraft.skotos.net/Theatre/Art.sam?url=' +
